---
description: The fixed set of rules every password on the platform must meet.
layout:
  width: wide
---
...
<summary><strong>My password is being rejected.</strong></summary>
...
<summary><strong>I just signed in with my current password and now I'm being asked to set a new one.</strong></summary>
